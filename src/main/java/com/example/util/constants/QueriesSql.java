...
public final class QueriesSql {
    ...
    private static final String SQL_UPDATE_WHERE_EMPLOYEE = " WHERE employee_id=?";

    private static final String SQL_DELETE_EMPLOYEE = "DELETE FROM employee WHERE employee_id=?";
    private static final String SQL_DELETE_EMPLOYEES_FROM_DEPARTMENT = "DELETE FROM employee WHERE dept_id=?";

    private static final String SQL_ALL_EMPLOYEE_FROM_DEPARTMENT = "SELECT * FROM employee WHERE dept_id=?";
    ...
    private static final String SQL_UPDATE_WHERE_DEPARTMENT = " WHERE dept_id=?";

    private static final String SQL_DELETE_DEPARTMENT = "DELETE FROM dept WHERE dept_id=?";
